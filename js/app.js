...
function setMyLightClass(e, desiredClass){
  var lightId = this.dataset.lightId;
...
btn3.addEventListener('click', function(){setMyLightGreen.apply(this);});
...
btn6.addEventListener('click', function(){setMyLightGreen.call(this);});
...
btn8.addEventListener('click', function(event){setMyLightClass.call(this, event, 'light-green')});
...
btn12.addEventListener('click', function(event){setLight12Class(event, 'light-green');});
...
btn13.addEventListener('click', function(event){setMyLightClass.bind(btn13).call(this, event, 'light-green');});
...
btn14.addEventListener('click', function(event){setMyLightClass.bind(this).call(this, event, 'light-green');});
